...
interface IMajorityVoting {
    ...
    /// @param None The default option state of a voter indicating the absence of from the vote. This option neither
    /// influences support nor participation.
    ...
    /// @notice Checks if the support value defined as $$\texttt{support} =
    /// \frac{N_\text{yes}}{N_\text{yes}+N_\text{no}}$$ for a proposal vote is greater than the support threshold.
    ...
    /// @notice Checks if the worst-case support value defined as $$\texttt{worstCaseSupport} = \frac{N_\text{yes}}{
    /// N_\text{total}-N_\text{abstain}}$$ for a proposal vote is greater than the support threshold.
    /// @param _proposalId The ID of the proposal.
    ...
    /// @notice Checks if the participation value defined as $$\texttt{participation} =
    /// \frac{N_\text{yes}+N_\text{no}+N_\text{abstain}}{N_\text{total}}$$ for a proposal vote is greater or equal than
    /// the minimum participation value.
    /// @param _proposalId The ID of the proposal.
